        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer_panel padding_bottom_half bottom20">
                    <a href="index-logistic.html" class="footer_logo bottom25"><img src="@if(setting()->get('dark_footer_logo')) {{asset('/storage/app/public/'. setting()->get('dark_footer_logo') )}} @else {{ static_asset('themes/dark/frontend/logistic/images/logo-transparent.png')}} @endif" alt="MegaOne"></a>
                    ...
                    <ul class="social-icons white wow fadeInUp" data-wow-delay="300ms">
                        @foreach (setting()->get('dark_social_links_name') as $key => $social_link_name)
                            @if($social_link_name || setting()->get('dark_social_links_icon')[$key])
                                <li><a href="{{setting()->get('dark_social_links_name')[$key]}}" target="_blank" class=""><i class="{{setting()->get('dark_social_links_icon')[$key]}}"></i> </a> </li>
                            @endif
                        @endforeach
                    </ul>
                </div>
        ...
        <div class="py-4 d-flex flex-lg-column"  style="color: white">
            ...
            <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <div class="order-2 order-md-1">
                    {!! setting()->get('dark_footer_copy_right') ?? '' !!}
                </div>
                <!--end::Copyright-->
                <!--begin::Nav-->
                <div class="nav nav-dark">
                    {!! setting()->get('dark_designed_by') ?? '' !!}
                </div>
                <!--end::Nav-->
            </div>
            <!--end::Container-->
