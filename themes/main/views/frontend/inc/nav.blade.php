    ...
    <nav class="navbar navbar-expand-lg transparent-bg static-nav">
        <div class="container">
            <a class="navbar-brand" href="index-logistic.html">
                <img src="{{ static_asset('themes/main/frontend/logistic/images/logo-transparent.png')}}" alt="logo" class="logo-default">
                <img src="{{ static_asset('themes/main/frontend/logistic/images/logo.png')}}" alt="logo" class="logo-scrolled">
            </a>
                ...
                <ul class="social-icons-simple white top40">
                    @foreach (setting()->get('main_social_links_name') as $key => $social_link_name)
                        @if($social_link_name || setting()->get('main_social_links_icon')[$key])
                            <li><a href="{{setting()->get('main_social_links_name')[$key]}}" class=""><i class="{{setting()->get('main_social_links_icon')[$key]}}"></i> </a> </li>
                        @endif
                    @endforeach
                </ul>
