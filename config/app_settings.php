...
return [
    ...
    'sections' => [
        'main_general' => [
            ...
            'inputs' => [
                [
                    'name' => 'main_app_name', // unique key for setting
                    ...
                    // 'rules' => 'min:2|max:20', // validation rules for this input
                    'value' => '', // any default value
                    // 'hint' => 'You can set the app name here' // help block text for input
                ],
                [
                    'name' => 'main_site_motto', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_site_icon', // unique key for setting
                ...
                [
                    'name' => 'main_primary_font', // unique key for setting
                ...
                [
                    'name' => 'main_base_color', // unique key for setting
                ...
                [
                    'name' => 'main_base_hover_color', // unique key for setting
        ...
        'main_global_seo' => [
            ...
            'inputs' => [
                [
                    'name' => 'main_meta_title', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_meta_description', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_meta_keywords', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_meta_image', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
        ...
        'main_social_links' => [
            ...
            'inputs' => [
                // [
                //     'name' => 'main_social_links_name', // unique key for setting
                ...
                // ],
                [
                    'name' => 'main_social_links', // unique key for setting
                    'type' => 'social_links', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Social Links', // label for input
                    'options' => [
                        'fab fa-facebook-square' => ' &#xf082; Facebook',
                ...
                [
                    'name' => 'main_social_links_icon', // unique key for setting
                    'label' => 'Social Links', // label for input
                    'type' => 'array', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'data_type' => 'array',
                    'value' => '', // any default value
        ...
        'main_cookies' => [
            ...
            'inputs' => [
                [
                    'name' => 'main_cookies_agreement_text', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_show_cookies_agreement',
                    'type' => 'checkbox',
        ...
        'main_header' => [
            ...
            'inputs' => [
                [
                    'name' => 'main_header_logo', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
        ...
        'main_footer' => [
            ...
            'inputs' => [
                [
                    'name' => 'main_footer_logo', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_footer_about_description', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_footer_contact_address', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_footer_contact_phone', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_footer_contact_email', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                ...
                [
                    'name' => 'main_footer_copy_right', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
        ...
        'dark_general' => [
            ...
            'inputs' => [
                [
                    'name' => 'dark_app_name', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Application Name', // label for input
                    // optional properties
                    'placeholder' => 'Application Name', // placeholder for input
                ...
                [
                    'name' => 'dark_site_motto', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Site Motto', // label for input
                    // optional properties
                    'placeholder' => 'Site Motto', // placeholder for input
                ...
                [
                    'name' => 'dark_site_icon', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Site Icon', // label for input
                    // optional properties
                    'placeholder' => 'Choose logo...', // placeholder for input
                ...
                [
                    'name' => 'dark_primary_font', // unique key for setting
                    'type' => 'select_font', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Primary font', // label for input
                    // optional properties
                    'placeholder' => 'Primary font', // placeholder for input
                ...
                [
                    'name' => 'dark_base_color', // unique key for setting
                    'id' => 'cp2', // unique key for setting
                    'type' => 'color', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Website Base Color', // label for input
                    // optional properties
                ...
                [
                    'name' => 'dark_base_hover_color', // unique key for setting
                    'id' => 'cp4', // unique key for setting
                    'type' => 'color', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Website Base Hover Color', // label for input
                    // optional properties
        ...
        'dark_global_seo' => [
            ...
            'inputs' => [
                [
                    'name' => 'dark_meta_title', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta Title', // label for input
                    // optional properties
                    'placeholder' => 'Meta Title', // placeholder for input
                ...
                [
                    'name' => 'dark_meta_description', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta description', // label for input
                    // optional properties
                    'placeholder' => 'Meta description', // placeholder for input
                ...
                [
                    'name' => 'dark_meta_keywords', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta Keywords', // label for input
                    // optional properties
                    'placeholder' => 'Keyword,Keyword', // placeholder for input
                ...
                [
                    'name' => 'dark_meta_image', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta Image', // label for input
                    // optional properties
                    'placeholder' => 'Choose Meta Image...', // placeholder for input
        ...
        'dark_social_links' => [
            ...
            'inputs' => [
                // [
                //     'name' => 'dark_social_links_name', // unique key for setting
                //     'url' => 'social_links_url', // unique key for setting
                //     'icon' => 'social_links_icon', // unique key for setting
                //     'type' => 'social_links', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                //     'label' => 'Social Links', // label for input
                ...
                // ],
                [
                    'name' => 'dark_social_links', // unique key for setting
                    'type' => 'social_links', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Social Links', // label for input
                    'options' => [
                        'fab fa-facebook-square' => ' &#xf082; Facebook',
                ...
                [
                    'name' => 'dark_social_links_icon', // unique key for setting
                    'label' => 'Social Links', // label for input
                    'type' => 'array', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'data_type' => 'array',
                    'value' => '', // any default value
        ...
        'dark_cookies' => [
            ...
            'inputs' => [
                [
                    'name' => 'dark_cookies_agreement_text', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Cookies Agreement Text', // label for input
                    // optional properties
                    'placeholder' => 'Cookies Agreement Text', // placeholder for input
                ...
                [
                    'name' => 'dark_show_cookies_agreement',
                    'type' => 'checkbox',
                    'label' => 'Show Cookies Agreement? : ',
                    'value' => '0',
                    'class' => 'w-auto form-control aiz-selectpicker',
        ...
        'dark_header' => [
            ...
            'inputs' => [
                [
                    'name' => 'dark_header_logo', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Header Logo', // label for input
                    // optional properties
                    'placeholder' => 'Choose logo...', // placeholder for input
        ...
        'dark_footer' => [
            ...
            'inputs' => [
                [
                    'name' => 'dark_footer_logo', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Footer Logo', // label for input
                    // optional properties
                    'placeholder' => 'Choose logo...', // placeholder for input
                ...
                [
                    'name' => 'dark_footer_about_description', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'About description', // label for input
                    // optional properties
                    'placeholder' => 'About description', // placeholder for input
                ...
                [
                    'name' => 'dark_footer_contact_address', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Contact address', // label for input
                    // optional properties
                    'placeholder' => 'Contact address', // placeholder for input
                ...
                [
                    'name' => 'dark_footer_contact_phone', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Contact phone', // label for input
                    // optional properties
                    'placeholder' => 'Contact phone', // placeholder for input
                ...
                [
                    'name' => 'dark_footer_contact_email', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Contact email', // label for input
                    // optional properties
                    'placeholder' => 'Contact email', // placeholder for input
                ...
                [
                    'name' => 'dark_footer_copy_right', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Copy right', // label for input
                    // optional properties
                    'placeholder' => 'Copy right', // placeholder for input
        ...
        'news_general' => [
            ...
            'inputs' => [
                [
                    'name' => 'news_app_name', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Application Name', // label for input
                    // optional properties
                    'placeholder' => 'Application Name', // placeholder for input
                ...
                [
                    'name' => 'news_site_motto', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Site Motto', // label for input
                    // optional properties
                    'placeholder' => 'Site Motto', // placeholder for input
                ...
                [
                    'name' => 'news_site_icon', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Site Icon', // label for input
                    // optional properties
                    'placeholder' => 'Choose logo...', // placeholder for input
                ...
                [
                    'name' => 'news_primary_font', // unique key for setting
                    'type' => 'select_font', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Primary font', // label for input
                    // optional properties
                    'placeholder' => 'Primary font', // placeholder for input
                ...
                [
                    'name' => 'news_base_color', // unique key for setting
                    'id' => 'cp2', // unique key for setting
                    'type' => 'color', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Website Base Color', // label for input
                    // optional properties
                ...
                [
                    'name' => 'news_base_hover_color', // unique key for setting
                    'id' => 'cp4', // unique key for setting
                    'type' => 'color', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Website Base Hover Color', // label for input
                    // optional properties
        ...
        'news_global_seo' => [
            ...
            'inputs' => [
                [
                    'name' => 'news_meta_title', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta Title', // label for input
                    // optional properties
                    'placeholder' => 'Meta Title', // placeholder for input
                ...
                [
                    'name' => 'news_meta_description', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta description', // label for input
                    // optional properties
                    'placeholder' => 'Meta description', // placeholder for input
                ...
                [
                    'name' => 'news_meta_keywords', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta Keywords', // label for input
                    // optional properties
                    'placeholder' => 'Keyword,Keyword', // placeholder for input
                ...
                [
                    'name' => 'news_meta_image', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Meta Image', // label for input
                    // optional properties
                    'placeholder' => 'Choose Meta Image...', // placeholder for input
        ...
        'news_social_links' => [
            ...
            'inputs' => [
                // [
                //     'name' => 'news_social_links_name', // unique key for setting
                //     'url' => 'social_links_url', // unique key for setting
                //     'icon' => 'social_links_icon', // unique key for setting
                //     'type' => 'social_links', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                //     'label' => 'Social Links', // label for input
                ...
                // ],
                [
                    'name' => 'news_social_links', // unique key for setting
                    'type' => 'social_links', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Social Links', // label for input
                    'options' => [
                        'fab fa-facebook-square' => ' &#xf082; Facebook',
                ...
                [
                    'name' => 'news_social_links_icon', // unique key for setting
                    'label' => 'Social Links', // label for input
                    'type' => 'array', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'data_type' => 'array',
                    'value' => '', // any default value
        ...
        'news_cookies' => [
            ...
            'inputs' => [
                [
                    'name' => 'news_cookies_agreement_text', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Cookies Agreement Text', // label for input
                    // optional properties
                    'placeholder' => 'Cookies Agreement Text', // placeholder for input
                ...
                [
                    'name' => 'news_show_cookies_agreement',
                    'type' => 'checkbox',
                    'label' => 'Show Cookies Agreement? : ',
                    'value' => '0',
                    'class' => 'w-auto form-control aiz-selectpicker',
        ...
        'news_header' => [
            ...
            'inputs' => [
                [
                    'name' => 'news_header_logo', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Header Logo', // label for input
                    // optional properties
                    'placeholder' => 'Choose logo...', // placeholder for input
        ...
        'news_footer' => [
            ...
            'inputs' => [
                [
                    'name' => 'news_footer_logo', // unique key for setting
                    'type' => 'image', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Footer Logo', // label for input
                    // optional properties
                    'placeholder' => 'Choose logo...', // placeholder for input
                ...
                [
                    'name' => 'news_footer_about_description', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'About description', // label for input
                    // optional properties
                    'placeholder' => 'About description', // placeholder for input
                ...
                [
                    'name' => 'news_footer_contact_address', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Contact address', // label for input
                    // optional properties
                    'placeholder' => 'Contact address', // placeholder for input
                ...
                [
                    'name' => 'news_footer_contact_phone', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Contact phone', // label for input
                    // optional properties
                    'placeholder' => 'Contact phone', // placeholder for input
                ...
                [
                    'name' => 'news_footer_contact_email', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Contact email', // label for input
                    // optional properties
                    'placeholder' => 'Contact email', // placeholder for input
                ...
                [
                    'name' => 'news_footer_copy_right', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'Copy right', // label for input
                    // optional properties
                    'placeholder' => 'Copy right', // placeholder for input
