            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-right font-weight-bold text-muted text-uppercase">{{translate('Actions')}}</th>
                    </tr>
                </thead>
                <tbody>
                ...
                @foreach(\App\ShipmentMission::where('mission_id',$data['mission']->id)->get() as $shipment_mission)
                    <tr class="font-weight-boldest">
                        <td class="pl-0 pt-7">D {{$shipment_mission->shipment->code}}</td>
                        ...
                        <td class="text-danger pr-0 pt-7 text-right">
                            @if($shipment_mission->mission->status_id != \App\Mission::DONE_STATUS)
