            ...
            <tbody>
                @foreach($captains as $key => $captain)
                        ...
                        <tr>
                            ...
                            <td width="15%"><a href="{{route('admin.captains.show',$captain->id)}}" >{{$captain->name}}</a></td>
                            <td width="15%">{{$captain->email}}</td>
                            <td width="15%">{{$captain->responsible_mobile}}</td>
                            <td width="10%">{{$captain->type}}</td>
                            <td width="10%"><a href="{{route('admin.branchs.show',$captain->branch_id)}}" >{{$captain->branch->name}}</a></td>
