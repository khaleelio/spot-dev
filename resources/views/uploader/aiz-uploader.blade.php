<div class="modal fade" id="aizUploaderModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-adaptive modal-dialog-centered modal-xl" role="document">
