				...
				<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container  text-center">
						...
						<div class="text-dark order-2 order-md-1">
							<span class="text-muted font-weight-bold mr-1">{{translate('Copyright')}} &copy; {{date('Y')}}</span>
							<a href="http://keenthemes.com/metronic" target="_blank"
								class="text-dark-75 text-hover-primary">{{translate('Spotlayer')}}</a> <span class="text-muted font-weight-bold mr-2">{{translate('v')}}{{ get_setting('current_version') }}</span>
						</div>
