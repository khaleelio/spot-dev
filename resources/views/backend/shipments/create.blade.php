                            ...
                            <div class="col-9 col-form-label">
                                <div class="radio-inline">
                                    <label class="radio radio-success  btn btn-default">
                                        <input type="radio" name="Shipment[type]" checked="checked" value="1" />
                                        <span></span>
                            ...
                            @if(\App\ShipmentSetting::getVal('is_date_required') == '1' || \App\ShipmentSetting::getVal('is_date_required') == null)
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" name="Shipment[shipping_date]" class="form-control" id="kt_datepicker_3" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2" id="select-how" name="Shipment[payment_type]">
                                        ...
                                        <option value="1">{{translate('Postpaid')}}</option>
                                        <option value="2">{{translate('Prepaid')}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2" id="select-how" name="Shipment[payment_method]">
                                        ...
                                        <option value="2">{{translate('Paypal')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div data-repeater-list="Package" class="col-lg-12">
                                    <div data-repeater-item class="row align-items-center" style="margin-top: 15px;padding-bottom: 15px;padding-top: 15px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input id="kt_touchspin_qty" type="text" name="qty" class="form-control" value="0" />
                                            <div class="d-md-none mb-2"></div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input id="kt_touchspin_weight" type="text" name="weight" class="form-control" value="0" />
                                            <div class="d-md-none mb-2"></div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input class="dimensions_r" type="text" class="form-control" placeholder="{{translate('Length')}}"  name="length"/>

                                        </div>
                                        <div class="col-md-2">

                                            <input class="dimensions_r" type="text" class="form-control" placeholder="{{translate('Width')}}" name="width" />

                                        </div>
                                        <div class="col-md-2">

                                            <input class="dimensions_r" type="text" class="form-control " placeholder="{{translate('Height')}}" name="height" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_2" type="text" class="form-control" value="{{\App\ShipmentSetting::getVal('def_tax')}}" name="Shipment[tax]" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_2_2" type="text" class="form-control" value="{{\App\ShipmentSetting::getVal('def_insurance')}}" name="Shipment[insurance]" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{translate('Shipping Cost')}}:</label>
                                        <input id="kt_touchspin_3" type="text" class="form-control" value="{{\App\ShipmentSetting::getVal('def_shipping_cost')}}" name="Shipment[shipping_cost]" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{translate('Return Cost')}}:</label>
                                        <input id="kt_touchspin_3" type="text" class="form-control" value="{{\App\ShipmentSetting::getVal('def_return_cost')}}" name="Shipment[return_cost]" />
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_4" type="text" class="form-control" value="0" name="Shipment[total_weight]" />
                                    </div>
                                </div>
