...
<div class="row">
    <div class="col-lg-7 mx-auto">
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" action="{{ route('addons.generate.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="text" name="unique_identifier" />
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="number" name="minimum_item_version" />
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="text" name="required_addons" />
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="text" name="controller_file_name" />
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="text" name="view_folder_name" />
                            </div>
                    ...
                    <div class="row">
                        <div class=" col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="text" name="model_file_name" />
                            </div>
                        ...
                        <div class=" col-md-6">
                            ...
                            <div>
                                <input class="form-control" type="text" name="route_file_name" />
                            </div>
