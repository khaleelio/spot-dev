        ...
        <div class="theme-sticky">
            <div class="info_bar">
                <div class="theme-action_bar">
                    <button type="submit" class="theme-save-btn">{{ Arr::get($settings, 'submit_btn_text', 'Save Settings') }}</button>
                </div>
            </div>
        </div>
        <!--start::Theme Sticky-->
        ...
        <div class="col-lg-12">
            <div class="theme" id="tabs">
                ...
                <div class="theme-content">
                    ...
                    <!--start::Theme Form-->
                    <form method="post" action="{{ route('website.theme.option.store') }}" class="mb-3 form-horizontal" enctype="multipart/form-data" role="form"  id="kt_form">
                        {!! csrf_field() !!}
