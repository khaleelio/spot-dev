<div class="card card-custom card-fit card-border card-collapsed widget mb-2" data-card="true" id="widget-{{$config['container_widget']->id}}" data-widget-id="{{$config['container_widget']->id}}">
