<div class="dragula-container ng-isolate-scope col-lg-3 p-3">
  <h2>{{$config['container']->name}}
    <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{ route('website.container.destroy', $config['container']->id)}} " title="{{ translate('Delete') }}">
