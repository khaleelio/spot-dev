...
@if (\App\Addon::where('unique_identifier', 'blog_addon')->first()->activated)
    @if(Auth::user()->user_type == 'admin' || in_array('1001', json_decode(Auth::user()->staff->role->permissions)))
        <li class="menu-item menu-item-submenu  {{ areActiveRoutes(['admin.articles.index','admin.articles.edit','admin.articles.create','admin.categories.index','admin.categories.view','admin.categories.edit','admin.categories.create','admin.tags.index','admin.tags.view','admin.tags.edit','admin.tags.create','admin.comments.index','admin.comments.edit'])}}" aria-haspopup="true" data-menu-toggle="hover">
            ...
            <div class="menu-submenu">
                ...
                <ul class="menu-subnav">
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('1001', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="menu-item {{ areActiveRoutes(['admin.articles.index','admin.articles.edit','admin.articles.create'])}}" aria-haspopup="true">
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('1002', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="menu-item {{ areActiveRoutes(['admin.categories.index','admin.categories.view','admin.categories.edit','admin.categories.create'])}}" aria-haspopup="true">
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('1003', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="menu-item {{ areActiveRoutes(['admin.tags.index','admin.tags.view','admin.tags.edit','admin.tags.create'])}}" aria-haspopup="true">
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('1004', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="menu-item {{ areActiveRoutes(['admin.comments.index','admin.comments.edit'])}}" aria-haspopup="true">
